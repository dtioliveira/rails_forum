...
Webflow.require('ix').init([
  {"slug":"aparece-1","name":"Aparece 1","value":{"style":{"x":"0px","y":"-100px"},"triggers":[{"type":"load","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"aparece-2","name":"Aparece 2","value":{"style":{"opacity":0,"x":"0px","y":"-100px"},"triggers":[{"type":"load","stepsA":[{"opacity":1,"wait":1000,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"icon","name":"icon","value":{"style":{"scale":0.5},"triggers":[{"type":"load","stepsA":[{"transition":"transform 500ms ease 0ms","scale":1}],"stepsB":[]}]}}
]);
